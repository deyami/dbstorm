...
import com.reform.dbstorm.zookeeper.exception.ZKTimeoutException;
...
import com.reform.dbstorm.zookeeper.exception.ZKInterruptedException;
import com.reform.dbstorm.zookeeper.exception.ZKKeeperException;

/**
 * zookeeper客户端，封装zookeeper的多数操作.
 * <br>
 * <ol>
 ...
 * </ol>
 *
 * @author huaiyu.du@opi-corp.com 2012-1-16 下午2:41:20
 *
 */
public class ZKClient implements Watcher {
	 ...
	 * 创建一个客户端实例.
	 *
	 * @param zkServers 服务器端点地址,比如：10.6.39.74:2181,10.6.39.80:2181,10.6.33.105:2181.
	 * 但zkServers不能包含任何chroot路径.去掉chroot路径是因为在zookeeper中还不能真正做到对chroot透明，很难统一api.
	 *
	 * @throws com.reform.dbstorm.zookeeper.exception.ZKTimeoutException 当链接等待时间超过<code>DEFAULT_CONNECTION_TIMEOUT</code>后
	 */
	 ...
	 * 创建一个客户端实例.
	 * @param zkServers 服务器端点地址,比如：10.6.39.74:2181,10.6.39.80:2181,10.6.33.105:2181.
	 * @param sessionTimeout 会话超时时间，客户端断开超过此时间后，服务端将会清除掉所有的相关信息，包括watcher和临时节点
	 */
	 ...
	 *
	 * @throws com.reform.dbstorm.zookeeper.exception.ZKTimeoutException 当链接等待时间超过connectionTimeout后
	 */
